  ...
  return (
    <>
      {isMobile ? (
        ...
        >
          <Link href={"/"} className="hover:font-bold hover:text-custom-purple">Zee</Link>
          <ul className="flex items-center justify-between gap-10 p-5 text-gray rounded-xl bg-white bg-opacity-60 border border-white">
