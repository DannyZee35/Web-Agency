...
const Pricing = () => {
  return (
    <div className="max-w-[1200px] m-auto p-10 sm:p-0">
      <h1 className="text-lg font-bold mb-5 text-center sm:text-left">
        Pricing
      </h1>
      ...
      <div className="mt-10 p-0 sm:p-10  sm:bg-white bg-transparent rounded-xl gap-10 sm:gap-0 flex flex-col sm:flex-row items-center sm:items-start justify-center sm:justify-between ">
        <div
          className="p-10 w-full sm:w-auto bg-white sm:bg-transparent transition-all duration-300 border group hover:bg-blue hover:text-white rounded-xl"
          style={{
            height: "500px",
            display: "flex",
        ...
        <div
          className=" p-10  transition-all duration-300 border group hover:bg-white hover:text-blue w-full sm:w-auto bg-blue rounded-xl text-white"
          style={{
            height: "500px",
            display: "flex",
            flexDirection: "column",
        ...
        >
          ...
          <button className="px-10 mt-10 p-3 group-hover:bg-blue group-hover:text-white bg-white text-blue rounded-full">
            Choose plan
          </button>
        </div>
